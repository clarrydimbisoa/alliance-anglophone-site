  ...
  fr: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Calendrier et format", `<p>Les demandes d’inscription sont ouvertes toute l’année, sous réserve des places disponibles. Les dates et horaires sont confirmés par écrit pour chaque programme. Les groupes ordinaires comptent de 6 à 15 participants.</p>`],
  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Schedule and format", `<p>Registration requests are open year-round, subject to availability. Dates and timetables are confirmed in writing for each program. Standard groups have 6 to 15 participants.</p>`],
  ...
  mg: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Daty sy format", `<p>Misokatra mandritra ny taona ny fangatahana fisoratana, araka ny toerana misy. Hamafisina an-tsoratra ny daty sy ora ho an’ny programa tsirairay. Misy mpandray anjara 6 ka hatramin’ny 15 ny groupe mahazatra.</p>`],
