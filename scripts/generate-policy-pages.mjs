  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Schedule and format", `<p>Paid-course registration requests for the September cohort are accepted through Thursday, 3 September 2026. Free-trial registration closed on 1 September. For participants already confirmed, the trial includes WhatsApp lessons and exercises from 7 to 11 September, followed by a WhatsApp group video session on Saturday, 12 September at 10:00. No payment is required for the trial. Standard groups have 6 to 15 participants, and timetables are confirmed in writing.</p>`],
  ...
  mg: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Daty sy format", `<p>Raisina hatramin’ny Alakamisy 3 Septambra 2026 ny fangatahana fisoratana misy sarany ho an’ny cohorte Septambra. Nikatona ny 1 Septambra ny fisoratana amin’ny herinandro fitsapana. Ho an’ireo mpandray anjara efa voamarina, misy lesona sy fanazaran-tena WhatsApp ny 7–11 Septambra ary regroupement vidéo WhatsApp ny Asabotsy 12 Septambra amin’ny 10 ora. Tsy misy fandoavana amin’ny essai. Misy mpandray anjara 6 ka hatramin’ny 15 ny groupe mahazatra ary hamafisina an-tsoratra ny fandaharam-potoana.</p>`],
...
function render(language, config, kind, filename) {
  ...
  const footer = { fr: "Demandes de cours jusqu’au 3 septembre — inscriptions à l’essai closes.", en: "Course requests through 3 September — free-trial registration closed.", mg: "Fangatahana cours hatramin’ny 3 Septambra — nikatona ny fisoratana amin’ny essai." }[language];
  return `<!DOCTYPE html>
<html lang="${language}">
<head>
  <meta charset="UTF-8">
