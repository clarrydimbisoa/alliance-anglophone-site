  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Schedule and format", `<p>Requests for the September cohort and its free trial week are accepted through Thursday, 3 September 2026. The trial includes WhatsApp lessons and exercises from 7 to 11 September, followed by a WhatsApp group video session on Saturday, 12 September at 10:00. No payment is required for the trial. Standard groups have 6 to 15 participants, and timetables are confirmed in writing.</p>`],
  ...
  mg: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Daty sy format", `<p>Raisina hatramin’ny Alakamisy 3 Septambra 2026 ny fangatahana ho an’ny cohorte Septambra sy ny herinandro fitsapana maimaim-poana. Misy lesona sy fanazaran-tena WhatsApp ny 7–11 Septambra, ary regroupement vidéo WhatsApp ny Asabotsy 12 Septambra amin’ny 10 ora. Tsy misy fandoavana amin’ny essai. Misy mpandray anjara 6 ka hatramin’ny 15 ny groupe mahazatra ary hamafisina an-tsoratra ny fandaharam-potoana.</p>`],
...
function render(language, config, kind, filename) {
  ...
  const footer = { fr: "Demandes jusqu’au 3 septembre — essai gratuit du 7 au 12 septembre 2026.", en: "Requests through 3 September — free trial from 7 to 12 September 2026.", mg: "Fangatahana hatramin’ny 3 Septambra — essai maimaim-poana ny 7–12 Septambra 2026." }[language];
  return `<!DOCTYPE html>
<html lang="${language}">
<head>
  <meta charset="UTF-8">
