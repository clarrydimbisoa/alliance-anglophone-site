  ...
  fr: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Calendrier et format", `<p>Les demandes d’inscription sont ouvertes toute l’année. Une nouvelle cohorte en ligne commence le premier lundi de chaque mois. La place, la date et les horaires sont confirmés par écrit pour chaque programme. Les groupes ordinaires comptent de 6 à 15 participants.</p>`],
        ["3. Prix et paiement", `<p>Tous les tarifs applicables sont publiés sur la page <a href="tarifs.html">Tarifs</a>. Le montant correspondant au programme choisi est confirmé par écrit avant tout paiement. Après confirmation écrite uniquement, les paiements officiels sont MVola au +261 34 920 1200 et Orange Money au +261 37 120 0712.</p>`],
  ...
  en: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Schedule and format", `<p>Registration requests are open year-round. A new online cohort begins on the first Monday of every month. Places, starting dates, and timetables are confirmed in writing for each program. Standard groups have 6 to 15 participants.</p>`],
        ["3. Prices and payment", `<p>All applicable fees are published on the <a href="pricing.html">Pricing</a> page. The amount for the selected program is confirmed in writing before any payment. Only after written confirmation, the official payment channels are MVola at +261 34 920 1200 and Orange Money at +261 37 120 0712.</p>`],
  ...
  mg: {
    ...
    terms: {
      ...
      sections: [
        ...
        ["2. Daty sy format", `<p>Misokatra mandritra ny taona ny fangatahana fisoratana. Manomboka amin’ny Alatsinainy voalohany amin’ny volana ny cohorte vaovao en ligne. Hamafisina an-tsoratra ny toerana, ny daty ary ny ora ho an’ny programa tsirairay. Misy mpandray anjara 6 ka hatramin’ny 15 ny groupe mahazatra.</p>`],
        ["3. Saram-piofanana sy fandoavana", `<p>Ao amin’ny pejy <a href="saram-piofanana.html">Saram-piofanana</a> no avoaka ny sarany rehetra ampiharina. Hamafisina an-tsoratra ny vola mifanaraka amin’ny programa voafidy alohan’ny handoavana. Aorian’ny fanamafisana an-tsoratra ihany, ny fomba fandoavana ofisialy dia MVola +261 34 920 1200 sy Orange Money +261 37 120 0712.</p>`],
...
function render(language, config, kind, filename) {
  ...
  const footer = { fr: "Anglais pratique pour les études, le travail et la communication professionnelle.", en: "Practical English for study, work, and professional communication.", mg: "Anglisy azo ampiasaina amin’ny fianarana, asa ary fifandraisana matihanina." }[language];
  return `<!DOCTYPE html>
<html lang="${language}">
<head>
  <meta charset="UTF-8">
